package br.com.cadastroit.services.testes;
...
public class ExecutorServiceTestes {
	...
	public void runApp() throws InterruptedException, ExecutionException {
		...
		for (Future<AtomicInteger> future : resultFuture) {
			// Didn't deliberately put a timeout here for the get method. Remember, the invoke All does not return until the task
			// is done.
	...
	public static void main(String[] args) throws ExecutionException {
		...
		try {
			new ExecutorServiceTestes().runApp();
